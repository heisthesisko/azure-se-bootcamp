...
**Intent:** Learn and deploy core features of Azure Private Link (Private Endpoint). This module builds on previous modules.
...
**Deploy**
```bash
bash infra/infra/m06_private_link.sh
```
