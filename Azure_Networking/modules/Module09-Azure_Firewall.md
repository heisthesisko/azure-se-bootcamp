    ...
    **Intent & Learning Objectives:** Managed firewall for centralized protection.
    **Estimated time:** 60–90 min

    **Key Features Demonstrated:**
    - Firewall IP config (PIP + VNet)
    - UDR egress via Firewall
    - Basic rules (L3/L7)

    **Top Problems/Features this module addresses:**
    - Add centralized L3-L7 controls
    - Enable threat protection at scale
...
> Some resources in this module may accrue cost (e.g., public IPs, App Gateway WAF_v2, Front Door, ExpressRoute, Bastion, vWAN). Use a training subscription and clean up when finished.
    ...
    See: `assets/diagrams/module09_flow.mmd`

    ## Sequence Diagram – Key Interactions
    See: `assets/diagrams/module09_sequence.mmd`
...
2. **Run this module's script**  
   ```bash
   bash infra/m09_firewall.sh
   ```
3. **Validate outcomes** – follow checks below.


    ### Validation
    Check Firewall private IP and UDR next hop; verify outbound still works and inbound remains controlled.
