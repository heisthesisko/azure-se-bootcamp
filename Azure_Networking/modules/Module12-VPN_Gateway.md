    # Module 12: VPN Gateway

    **Intent & Learning Objectives:** Site-to-site (VyOS) or P2S VPN to Azure.
    **Estimated time:** 75–120 min

    **Key Features Demonstrated:**
    - VNet Gateway (VpnGw1)
    - Local network gateway
    - S2S connection + shared key

    **Top Problems/Features this module addresses:**
    - Extend VNet to on-prem securely
    - Support legacy HL7 and PACS integrations
...
> Some resources in this module may accrue cost (e.g., public IPs, App Gateway WAF_v2, Front Door, ExpressRoute, Bastion, vWAN). Use a training subscription and clean up when finished.
    ...
    See: `assets/diagrams/module12_flow.mmd`

    ## Sequence Diagram – Key Interactions
    See: `assets/diagrams/module12_sequence.mmd`
...
2. **Run this module's script**  
   ```bash
   bash infra/m12_vpn_gateway.sh
   ```
3. **Validate outcomes** – follow checks below.


    ### Validation
    After VyOS config, verify S2S status = `Connected`. Ping on-prem IPs from Azure VM.
