    ...
    **Intent & Learning Objectives:** Authoritative DNS zones and records; private DNS.
    **Estimated time:** 45–60 min

    **Key Features Demonstrated:**
    - Public zone + records
    - Private DNS A records for PEs
    - Resolver testing

    **Top Problems/Features this module addresses:**
    - Centralize DNS management for apps
    - Resolve Private Endpoint FQDNs correctly
...
> Some resources in this module may accrue cost (e.g., public IPs, App Gateway WAF_v2, Front Door, ExpressRoute, Bastion, vWAN). Use a training subscription and clean up when finished.
    ...
    See: `assets/diagrams/module06_flow.mmd`

    ## Sequence Diagram – Key Interactions
    See: `assets/diagrams/module06_sequence.mmd`
...
2. **Run this module's script**  
   ```bash
   bash infra/m06_azure_dns.sh
   ```
3. **Validate outcomes** – follow checks below.


    ### Validation
    Resolve `app.${PREFIX}.training` to your App Gateway public IP.
