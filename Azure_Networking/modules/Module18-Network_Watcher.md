    # Module 18: Network Watcher

    **Intent & Learning Objectives:** Monitoring, diagnostics, and analytics.
    **Estimated time:** 45–60 min

    **Key Features Demonstrated:**
    - NSG flow logs to LA
    - Connection Monitor
    - KQL basics for traffic

    **Top Problems/Features this module addresses:**
    - Gain packet-level visibility
    - Troubleshoot hybrid and PE DNS issues
...
> Some resources in this module may accrue cost (e.g., public IPs, App Gateway WAF_v2, Front Door, ExpressRoute, Bastion, vWAN). Use a training subscription and clean up when finished.
    ...
    See: `assets/diagrams/module18_flow.mmd`

    ## Sequence Diagram – Key Interactions
    See: `assets/diagrams/module18_sequence.mmd`
...
2. **Run this module's script**  
   ```bash
   bash infra/m18_network_watcher.sh
   ```
3. **Validate outcomes** – follow checks below.


    ### Validation
    Run KQL in LA for NSG flow logs and view Connection Monitor insights.
