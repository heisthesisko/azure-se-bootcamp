    # Module 4: Public IP Addresses

    **Intent & Learning Objectives:** Public reachability for selected resources.
    **Estimated time:** 30–45 min

    **Key Features Demonstrated:**
    - Standard public IP SKU
    - DNS label assignment
    - Attach/detach to NIC/LB

    **Top Problems/Features this module addresses:**
    - Expose only needed services publicly
    - Standardize public endpoints with DNS labels
...
> Some resources in this module may accrue cost (e.g., public IPs, App Gateway WAF_v2, Front Door, ExpressRoute, Bastion, vWAN). Use a training subscription and clean up when finished.
    ...
    See: `assets/diagrams/module04_flow.mmd`

    ## Sequence Diagram – Key Interactions
    See: `assets/diagrams/module04_sequence.mmd`
...
2. **Run this module's script**  
   ```bash
   bash infra/m04_public_ip.sh
   ```
3. **Validate outcomes** – follow checks below.


    ### Validation
    Confirm DNS labels: `nslookup $LB_DNS_LABEL.$LOCATION.cloudapp.azure.com`. Attach/detach PIPs as needed.
