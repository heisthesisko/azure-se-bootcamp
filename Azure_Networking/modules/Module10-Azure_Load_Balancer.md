    # Module 10: Azure Load Balancer

    **Intent & Learning Objectives:** L4 load balancing for TCP/UDP.
    **Estimated time:** 60–90 min

    **Key Features Demonstrated:**
    - Backend pool + probe + rule
    - LB with Standard SKU
    - Scale out VMs with cloud-init

    **Top Problems/Features this module addresses:**
    - Achieve high availability for web tier
    - Scale out without app changes
...
> Some resources in this module may accrue cost (e.g., public IPs, App Gateway WAF_v2, Front Door, ExpressRoute, Bastion, vWAN). Use a training subscription and clean up when finished.
    ...
    See: `assets/diagrams/module10_flow.mmd`

    ## Sequence Diagram – Key Interactions
    See: `assets/diagrams/module10_sequence.mmd`
...
2. **Run this module's script**  
   ```bash
   bash infra/m10_load_balancer.sh
   ```
3. **Validate outcomes** – follow checks below.


    ### Validation
    Open the LB public DNS name and observe round-robin responses from `vm-web-1/2`.
