    # Module 15: Azure Front Door

    **Intent & Learning Objectives:** Global HTTP/HTTPS load balancing and acceleration.
    **Estimated time:** 60–90 min

    **Key Features Demonstrated:**
    - AFD profile/endpoint/origin
    - Route to App Gateway
    - HTTPS redirect

    **Top Problems/Features this module addresses:**
    - Accelerate global patient portal access
    - Edge WAF + CDN patterns
...
> Some resources in this module may accrue cost (e.g., public IPs, App Gateway WAF_v2, Front Door, ExpressRoute, Bastion, vWAN). Use a training subscription and clean up when finished.
    ...
    See: `assets/diagrams/module15_flow.mmd`

    ## Sequence Diagram – Key Interactions
    See: `assets/diagrams/module15_sequence.mmd`
...
2. **Run this module's script**  
   ```bash
   bash infra/m15_front_door.sh
   ```
3. **Validate outcomes** – follow checks below.


    ### Validation
    Browse `https://<endpoint>.azurefd.net/` and confirm it routes to AppGW backend.
