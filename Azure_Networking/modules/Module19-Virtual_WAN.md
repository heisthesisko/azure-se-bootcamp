    # Module 19: Virtual WAN

    **Intent & Learning Objectives:** Large-scale branch connectivity and routing.
    ...
    **Top Problems/Features this module addresses:**
    - Unify branch connectivity
    - Route/secure at the hub with policy
...
> Some resources in this module may accrue cost (e.g., public IPs, App Gateway WAF_v2, Front Door, ExpressRoute, Bastion, vWAN). Use a training subscription and clean up when finished.
    ...
    See: `assets/diagrams/module19_flow.mmd`

    ## Sequence Diagram – Key Interactions
    See: `assets/diagrams/module19_sequence.mmd`
...
2. **Run this module's script**  
   ```bash
   bash infra/m19_virtual_wan.sh
   ```
3. **Validate outcomes** – follow checks below.


    ### Validation
    Check vHub and VPN gateway status; ensure connection reaches `Connected`.
