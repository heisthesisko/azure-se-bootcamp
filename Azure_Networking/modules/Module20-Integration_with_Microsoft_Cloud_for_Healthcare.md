    ...
    **Intent & Learning Objectives:** Secure networking for AHDS (FHIR/DICOM).
    **Estimated time:** 75–120 min

    **Key Features Demonstrated:**
    - AHDS workspace + services
    - FHIR/DICOM Private Endpoints
    - Compliance notes

    **Top Problems/Features this module addresses:**
    - Network the AHDS FHIR/DICOM reference
    - Lock down with Private Endpoints + RBAC
...
> Some resources in this module may accrue cost (e.g., public IPs, App Gateway WAF_v2, Front Door, ExpressRoute, Bastion, vWAN). Use a training subscription and clean up when finished.
    ...
    See: `assets/diagrams/module20_flow.mmd`

    ## Sequence Diagram – Key Interactions
    See: `assets/diagrams/module20_sequence.mmd`
...
3. **Validate outcomes** – follow checks below.
    ...
    ### Validation
    Use `az rest` to call FHIR metadata endpoint via Private Endpoint (MI or token required).
