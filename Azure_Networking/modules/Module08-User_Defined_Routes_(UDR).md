    # Module 8: User Defined Routes (UDR)

    **Intent & Learning Objectives:** Custom routing tables for traffic control.
    ...
    **Top Problems/Features this module addresses:**
    - Force egress through security appliances
    - Control asymmetric routing in hybrid
...
> Some resources in this module may accrue cost (e.g., public IPs, App Gateway WAF_v2, Front Door, ExpressRoute, Bastion, vWAN). Use a training subscription and clean up when finished.
    ...
    See: `assets/diagrams/module08_flow.mmd`

    ## Sequence Diagram – Key Interactions
    See: `assets/diagrams/module08_sequence.mmd`
...
2. **Run this module's script**  
   ```bash
   bash infra/m08_udr.sh
   ```
3. **Validate outcomes** – follow checks below.


    ### Validation
    On web VM: `curl ifconfig.me` should egress via Firewall once configured.
