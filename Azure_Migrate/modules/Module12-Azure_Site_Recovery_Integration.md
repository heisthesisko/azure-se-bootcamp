# Module 12: Azure Site Recovery Integration

    ### Intent & Learning Objectives
    - Understand **Azure Site Recovery Integration** in the context of healthcare migrations.
    ...
    - Add DR posture after migration.
...
- Commit failover
    ...
    > [!IMPORTANT]
    > ASR supports compliance goals by reducing outage impact on care delivery.

    ### Architecture Diagram – Flow
    ```mermaid
flowchart TB
  AzureVMs --> ASR[(Azure Site Recovery)] --> DRRegion
```
...
sequenceDiagram
  ...
  participant ASR as Site Recovery
  Eng->>ASR: Enable protection
  ASR-->>Eng: Test failover success
```
    ...
    3. **Run scripts**: `infra/08_enable_asr.sh`
       - Follow on-screen prompts or review the scripts before execution.
    4. Keep runbooks updated with app-specific steps.
