    ...
    # Module07: Azure Files

    **Top Problems/Features Addressed**
    1. SMB share for lift-and-shift.
1. Cross-platform SMB 3.1.1 mounting.

    **Intent & Learning Objectives**
    - Understand Azure Files and when to use it.
    - Deploy and validate using Bash + Azure CLI.
    - Demonstrate three or more core features.

    **Key Features Demonstrated**
    - Create file share.
- Mount from Linux VM using cifs.
