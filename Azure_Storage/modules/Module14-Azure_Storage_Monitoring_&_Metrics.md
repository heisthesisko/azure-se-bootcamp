# Module 14: Azure Storage Monitoring & Metrics
**Intent & Learning Objectives:** Real-time monitoring and alerting.
...
flowchart TB
  ...
  DB --> SA
```
*See also:* `assets/diagrams/module14_flow.mmd`
...
```
*See also:* `assets/diagrams/module14_sequence.mmd`
...
## Files & Scripts
- Module script: `infra/m14_monitoring_metrics.sh`
- Diagrams: `assets/diagrams/module14_flow.mmd`, `assets/diagrams/module14_sequence.mmd`
