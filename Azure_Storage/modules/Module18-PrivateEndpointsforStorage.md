    ...
    # Module18: Private Endpoints for Storage

    **Top Problems/Features Addressed**
    1. Private IP access only.
1. Integration with Private DNS.

    **Intent & Learning Objectives**
    - Understand Private Endpoints for Storage and when to use it.
    - Deploy and validate using Bash + Azure CLI.
    - Demonstrate three or more core features.

    **Key Features Demonstrated**
    - Create PEs for blob/dfs/file.
- Create PDNS zones and links.
- Resolve/test from VM.
...
flowchart TB
  ...
  VM --> SA
    ...
    2. Execute scripts for this module:
       - `scripts/18_private_endpoints.sh`
