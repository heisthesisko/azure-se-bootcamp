    ...
    # Module19: Azure Storage Firewall and VNet Rules

    **Top Problems/Features Addressed**
    1. Default deny posture.
1. Allow only VNets/IPs.

    **Intent & Learning Objectives**
    - Understand Azure Storage Firewall and VNet Rules and when to use it.
...
flowchart TB
  ...
  VM --> SA
    ...
    2. Execute scripts for this module:
       - `scripts/19_firewall_vnet_rules.sh`
