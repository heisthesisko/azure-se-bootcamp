    ...
    # Module05: Shared Access Signatures (SAS)

    **Top Problems/Features Addressed**
    1. Grant time-bound, scoped access.
1. Avoid sharing account keys.

    **Intent & Learning Objectives**
    - Understand Shared Access Signatures (SAS) and when to use it.
    - Deploy and validate using Bash + Azure CLI.
    - Demonstrate three or more core features.

    **Key Features Demonstrated**
    - Generate container and queue SAS.
- Use SAS in PHP and Python apps.
- Rotate SAS and set least privilege.
