# Module 15: Azure Storage Analytics & Logging
**Intent & Learning Objectives:** Detailed logging for auditing.
...
- - Blob versioning (rolling back changes)
- - Change feed for append-only audit trail
- - Inventory policy for dataset visibility
...
flowchart TB
  ...
  DB --> SA
```
*See also:* `assets/diagrams/module15_flow.mmd`
...
```
*See also:* `assets/diagrams/module15_sequence.mmd`
...
2. **Run the module script**
   ```bash
   bash infra/m15_analytics_logging.sh
   ```
3. **Validate outcome**
...
## Files & Scripts
- Module script: `infra/m15_analytics_logging.sh`
- Diagrams: `assets/diagrams/module15_flow.mmd`, `assets/diagrams/module15_sequence.mmd`
