    ...
    # Module09: Azure Disk Storage

    **Top Problems/Features Addressed**
    1. Persistent block storage for VMs.
1. Support for snapshots/backups.

    **Intent & Learning Objectives**
    - Understand Azure Disk Storage and when to use it.
    - Deploy and validate using Bash + Azure CLI.
    - Demonstrate three or more core features.

    **Key Features Demonstrated**
    - Create and attach a disk.
- Partition/format/mount on Linux.
- Discuss snapshot/backup.
