...
**Intent & Learning Objectives:** Deploy AHDS (FHIR/DICOM) and integrate with Storage.
...
- - Secure export to ADLS Gen2
- - Role-based access & Private Endpoints (extend)
...
flowchart TB
  ...
  DB --> SA
```
*See also:* `assets/diagrams/module20_flow.mmd`
...
```
*See also:* `assets/diagrams/module20_sequence.mmd`
...
2. **Run the module script**
   ```bash
   bash infra/m20_microsoft_cloud_for_healthcare.sh
   ```
3. **Validate outcome**
...
## Files & Scripts
- Module script: `infra/m20_microsoft_cloud_for_healthcare.sh`
- Diagrams: `assets/diagrams/module20_flow.mmd`, `assets/diagrams/module20_sequence.mmd`
