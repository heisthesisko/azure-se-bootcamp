# Module 11: Azure AD/Entra ID Integration
**Intent & Learning Objectives:** Centralized identity for token-based access.

**Top 2 problems this solves / features provided:**
- Managed Identity tokens
- Eliminate account keys for apps
...
flowchart TB
  ...
  DB --> SA
```
*See also:* `assets/diagrams/module11_flow.mmd`
...
```
*See also:* `assets/diagrams/module11_sequence.mmd`
...
2. **Run the module script**
   ```bash
   bash infra/m11_entra_integration.sh
   ```
3. **Validate outcome**
...
## Files & Scripts
- Module script: `infra/m11_entra_integration.sh`
- Diagrams: `assets/diagrams/module11_flow.mmd`, `assets/diagrams/module11_sequence.mmd`
