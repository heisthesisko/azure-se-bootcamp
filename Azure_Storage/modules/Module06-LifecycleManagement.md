    ...
    # Module06: Lifecycle Management

    **Top Problems/Features Addressed**
    1. Automate cost control over time.
1. Apply rules to specific prefixes.

    **Intent & Learning Objectives**
    - Understand Lifecycle Management and when to use it.
    - Deploy and validate using Bash + Azure CLI.
    - Demonstrate three or more core features.

    **Key Features Demonstrated**
    - Author JSON policy.
- Tier to Cool/Archive; delete after 365 days.
