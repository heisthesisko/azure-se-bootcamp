# Module 3: Azure Kubernetes Service (AKS)

**Intent & Learning Objectives**  
Managed Kubernetes for orchestrating complex healthcare container workloads.
...
bash infra/module03_azure_kubernetes_service_aks.sh || true
```
