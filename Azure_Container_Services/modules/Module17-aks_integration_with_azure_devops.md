# Module 17: AKS Integration with Azure DevOps

**Intent & Learning Objectives**  
CI/CD pipelines for rapid, compliant healthcare app delivery.
...
bash infra/module17_aks_integration_with_azure_devops.sh || true
```
