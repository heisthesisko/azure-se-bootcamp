# Module 15: AKS Integration with Azure Arc

**Intent & Learning Objectives**  
Hybrid and multi-cloud management for healthcare container workloads.
...
bash infra/module15_aks_integration_with_azure_arc.sh || true
```
