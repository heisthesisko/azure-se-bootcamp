# Module 9: AKS Security & Policy Management

**Intent & Learning Objectives**  
RBAC, network policies, and Azure Policy for healthcare compliance (HIPAA, HITRUST).
...
bash infra/module09_aks_security_policy_management.sh || true
```
