# Module 14: AKS Integration with Azure Monitor & Defender

**Intent & Learning Objectives**  
Unified monitoring and security for healthcare containers.
...
bash infra/module14_aks_integration_with_azure_monitor_defender.sh || true
```
