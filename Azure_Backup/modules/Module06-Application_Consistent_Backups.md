# Module 6: Application Consistent Backups

**Intent & Learning Objectives**  
This module introduces **Application Consistent Backups** and shows how to apply it in a healthcare context where electronic protected health information (ePHI) must be safeguarded under HIPAA. You will learn to: Pre/post scripts, Quiesce DB, VSS (Windows) overview.
...
- Pre/post scripts
- Quiesce DB
- VSS (Windows) overview

**Architecture Diagram (Flow)**  
```mermaid
---
title: Module 6 – Application Consistent Backups (Flow)
---
flowchart TB
...
```mermaid
---
title: Module 6 – Application Consistent Backups (Sequence)
---
sequenceDiagram
...
```bash
bash infra/06_app_consistent.sh
```
...
## Pros, Cons & Insights
**Pros**
- Application Consistent Backups improves resilience for clinical systems and reduces RTO/RPO.
