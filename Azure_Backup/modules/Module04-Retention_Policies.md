# Module 4: Retention Policies

**Intent & Learning Objectives**  
This module introduces **Retention Policies** and shows how to apply it in a healthcare context where electronic protected health information (ePHI) must be safeguarded under HIPAA. You will learn to: Daily/weekly retention, Long-term retention, Policy updates.
...
- Meet HIPAA record retention objectives
...
```mermaid
---
title: Module 4 – Retention Policies (Flow)
---
flowchart TB
...
```mermaid
---
title: Module 4 – Retention Policies (Sequence)
---
sequenceDiagram
...
## Pros, Cons & Insights
**Pros**
- Retention Policies improves resilience for clinical systems and reduces RTO/RPO.
