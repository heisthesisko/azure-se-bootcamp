# Module 15: Encryption at Rest and In Transit

**Intent & Learning Objectives**  
This module introduces **Encryption at Rest and In Transit** and shows how to apply it in a healthcare context where electronic protected health information (ePHI) must be safeguarded under HIPAA. You will learn to: CMK overview, TLS in transit, Key rotation plan.
...
```mermaid
---
title: Module 15 – Encryption at Rest and In Transit (Flow)
---
flowchart TB
...
```mermaid
---
title: Module 15 – Encryption at Rest and In Transit (Sequence)
---
sequenceDiagram
...
## Pros, Cons & Insights
**Pros**
- Encryption at Rest and In Transit improves resilience for clinical systems and reduces RTO/RPO.
