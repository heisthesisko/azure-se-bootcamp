# Module 3: Backup Scheduling

**Intent & Learning Objectives**  
This module introduces **Backup Scheduling** and shows how to apply it in a healthcare context where electronic protected health information (ePHI) must be safeguarded under HIPAA. You will learn to: Daily schedule, Time windows, Policy assignment.
...
```mermaid
---
title: Module 3 – Backup Scheduling (Flow)
---
flowchart TB
...
```mermaid
---
title: Module 3 – Backup Scheduling (Sequence)
---
sequenceDiagram
...
## Pros, Cons & Insights
**Pros**
- Backup Scheduling improves resilience for clinical systems and reduces RTO/RPO.
