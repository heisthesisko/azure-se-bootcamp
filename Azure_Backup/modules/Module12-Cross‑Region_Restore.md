# Module 12: Cross‑Region Restore

**Intent & Learning Objectives**  
This module introduces **Cross‑Region Restore** and shows how to apply it in a healthcare context where electronic protected health information (ePHI) must be safeguarded under HIPAA. You will learn to: Enable GRS, CRR workflow, Validate restore.
...
```mermaid
---
title: Module 12 – Cross‑Region Restore (Flow)
---
flowchart TB
...
```mermaid
---
title: Module 12 – Cross‑Region Restore (Sequence)
---
sequenceDiagram
...
```bash
bash infra/12_cross_region_restore.sh
```
...
## Pros, Cons & Insights
**Pros**
- Cross‑Region Restore improves resilience for clinical systems and reduces RTO/RPO.
