# Module 14: Soft Delete

**Intent & Learning Objectives**  
This module introduces **Soft Delete** and shows how to apply it in a healthcare context where electronic protected health information (ePHI) must be safeguarded under HIPAA. You will learn to: Enable/validate, Retention period, Undelete demo.
...
- Guardrail against malicious deletion
- Help with insider threat
...
```mermaid
---
title: Module 14 – Soft Delete (Flow)
---
flowchart TB
...
```mermaid
---
title: Module 14 – Soft Delete (Sequence)
---
sequenceDiagram
...
## Pros, Cons & Insights
**Pros**
- Soft Delete improves resilience for clinical systems and reduces RTO/RPO.
