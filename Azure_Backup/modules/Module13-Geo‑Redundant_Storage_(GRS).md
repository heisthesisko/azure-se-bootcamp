# Module 13: Geo‑Redundant Storage (GRS)

**Intent & Learning Objectives**  
This module introduces **Geo‑Redundant Storage (GRS)** and shows how to apply it in a healthcare context where electronic protected health information (ePHI) must be safeguarded under HIPAA. You will learn to: Set redundancy, Understand costs, Test regional durability.
...
- Set redundancy
- Understand costs
- Test regional durability

**Architecture Diagram (Flow)**  
```mermaid
---
title: Module 13 – Geo‑Redundant Storage (GRS) (Flow)
---
flowchart TB
...
```mermaid
---
title: Module 13 – Geo‑Redundant Storage (GRS) (Sequence)
---
sequenceDiagram
...
## Pros, Cons & Insights
**Pros**
- Geo‑Redundant Storage (GRS) improves resilience for clinical systems and reduces RTO/RPO.
