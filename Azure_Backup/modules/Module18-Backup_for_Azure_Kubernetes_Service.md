# Module 18: Backup for Azure Kubernetes Service

**Intent & Learning Objectives**  
This module introduces **Backup for Azure Kubernetes Service** and shows how to apply it in a healthcare context where electronic protected health information (ePHI) must be safeguarded under HIPAA. You will learn to: PV backup, AKS registration, Restore namespace.
...
```mermaid
---
title: Module 18 – Backup for Azure Kubernetes Service (Flow)
---
flowchart TB
...
```mermaid
---
title: Module 18 – Backup for Azure Kubernetes Service (Sequence)
---
sequenceDiagram
...
## Pros, Cons & Insights
**Pros**
- Backup for Azure Kubernetes Service improves resilience for clinical systems and reduces RTO/RPO.
