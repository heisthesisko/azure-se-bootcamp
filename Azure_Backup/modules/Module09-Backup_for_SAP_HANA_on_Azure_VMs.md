# Module 9: Backup for SAP HANA on Azure VMs

**Intent & Learning Objectives**  
This module introduces **Backup for SAP HANA on Azure VMs** and shows how to apply it in a healthcare context where electronic protected health information (ePHI) must be safeguarded under HIPAA. You will learn to: Register HANA, Schedule backups, Restore catalog.
...
- Protect SAP HANA healthcare ops
- Compliance-grade DB protection
...
```mermaid
---
title: Module 9 – Backup for SAP HANA on Azure VMs (Flow)
---
flowchart TB
...
```mermaid
---
title: Module 9 – Backup for SAP HANA on Azure VMs (Sequence)
---
sequenceDiagram
...
## Pros, Cons & Insights
**Pros**
- Backup for SAP HANA on Azure VMs improves resilience for clinical systems and reduces RTO/RPO.
