# Module 1: Azure Backup Vault

**Intent & Learning Objectives**  
This module introduces **Azure Backup Vault** and shows how to apply it in a healthcare context where electronic protected health information (ePHI) must be safeguarded under HIPAA. You will learn to: Create Recovery Services vault, Set storage redundancy, Enable soft delete.
...
- Centralize protected PHI backups
- Standardize policies across workloads
...
```mermaid
---
title: Module 1 – Azure Backup Vault (Flow)
---
flowchart TB
...
```mermaid
---
title: Module 1 – Azure Backup Vault (Sequence)
---
sequenceDiagram
...
## Pros, Cons & Insights
**Pros**
- Azure Backup Vault improves resilience for clinical systems and reduces RTO/RPO.
