# Module 5: Instant Restore

**Intent & Learning Objectives**  
This module introduces **Instant Restore** and shows how to apply it in a healthcare context where electronic protected health information (ePHI) must be safeguarded under HIPAA. You will learn to: File-level restore, Disks restore, Mount recovery point.
...
- Recover from clinician deletion
...
```mermaid
---
title: Module 5 – Instant Restore (Flow)
---
flowchart TB
...
```mermaid
---
title: Module 5 – Instant Restore (Sequence)
---
sequenceDiagram
...
```bash
bash infra/05_instant_restore.sh
```
...
## Pros, Cons & Insights
**Pros**
- Instant Restore improves resilience for clinical systems and reduces RTO/RPO.
