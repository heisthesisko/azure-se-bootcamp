# Module 11: Backup for Azure Blobs

**Intent & Learning Objectives**  
This module introduces **Backup for Azure Blobs** and shows how to apply it in a healthcare context where electronic protected health information (ePHI) must be safeguarded under HIPAA. You will learn to: Versioning, Soft delete, Point-in-time restore.
...
- Protect unstructured PHI
- Recover ransomware-altered blobs
...
```mermaid
---
title: Module 11 – Backup for Azure Blobs (Flow)
---
flowchart TB
...
```mermaid
---
title: Module 11 – Backup for Azure Blobs (Sequence)
---
sequenceDiagram
...
## Pros, Cons & Insights
**Pros**
- Backup for Azure Blobs improves resilience for clinical systems and reduces RTO/RPO.
