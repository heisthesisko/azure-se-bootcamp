# Module 17: Role‑Based Access Control (RBAC)

**Intent & Learning Objectives**  
This module introduces **Role‑Based Access Control (RBAC)** and shows how to apply it in a healthcare context where electronic protected health information (ePHI) must be safeguarded under HIPAA. You will learn to: Built-in roles, Scoped assignments, PIM note.
...
```mermaid
---
title: Module 17 – Role‑Based Access Control (RBAC) (Flow)
---
flowchart TB
...
```mermaid
---
title: Module 17 – Role‑Based Access Control (RBAC) (Sequence)
---
sequenceDiagram
...
```bash
bash infra/17_rbac.sh <user@contoso.com>
```
...
## Pros, Cons & Insights
**Pros**
- Role‑Based Access Control (RBAC) improves resilience for clinical systems and reduces RTO/RPO.
