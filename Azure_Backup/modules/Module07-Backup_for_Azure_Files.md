# Module 7: Backup for Azure Files

**Intent & Learning Objectives**  
This module introduces **Backup for Azure Files** and shows how to apply it in a healthcare context where electronic protected health information (ePHI) must be safeguarded under HIPAA. You will learn to: Protect Azure Files, PITR, Policy assignments.
...
```mermaid
---
title: Module 7 – Backup for Azure Files (Flow)
---
flowchart TB
...
```mermaid
---
title: Module 7 – Backup for Azure Files (Sequence)
---
sequenceDiagram
...
```bash
bash infra/07_backup_azure_files.sh
```
...
## Pros, Cons & Insights
**Pros**
- Backup for Azure Files improves resilience for clinical systems and reduces RTO/RPO.
