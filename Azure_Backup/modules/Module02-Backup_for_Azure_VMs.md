# Module 2: Backup for Azure VMs

**Intent & Learning Objectives**  
This module introduces **Backup for Azure VMs** and shows how to apply it in a healthcare context where electronic protected health information (ePHI) must be safeguarded under HIPAA. You will learn to: Protect Linux VM, On-demand backup, Restore options overview.
...
- Rapid VM protection
- Reduce RTO for clinical services
...
```mermaid
---
title: Module 2 – Backup for Azure VMs (Flow)
---
flowchart TB
...
```mermaid
---
title: Module 2 – Backup for Azure VMs (Sequence)
---
sequenceDiagram
...
## Pros, Cons & Insights
**Pros**
- Backup for Azure VMs improves resilience for clinical systems and reduces RTO/RPO.
