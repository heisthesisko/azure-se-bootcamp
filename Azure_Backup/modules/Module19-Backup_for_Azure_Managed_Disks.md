# Module 19: Backup for Azure Managed Disks

**Intent & Learning Objectives**  
This module introduces **Backup for Azure Managed Disks** and shows how to apply it in a healthcare context where electronic protected health information (ePHI) must be safeguarded under HIPAA. You will learn to: Disk snapshot protection, Restore disks, Attach to VM.
...
- Granular protection of data disks
- Recover outside VM context


**Key Features Demonstrated**
- Disk snapshot protection
- Restore disks
- Attach to VM
...
```mermaid
---
title: Module 19 – Backup for Azure Managed Disks (Flow)
---
flowchart TB
...
```mermaid
---
title: Module 19 – Backup for Azure Managed Disks (Sequence)
---
sequenceDiagram
...
## Pros, Cons & Insights
**Pros**
- Backup for Azure Managed Disks improves resilience for clinical systems and reduces RTO/RPO.
