# Module 10: Backup for On‑Premises Servers

**Intent & Learning Objectives**  
This module introduces **Backup for On‑Premises Servers** and shows how to apply it in a healthcare context where electronic protected health information (ePHI) must be safeguarded under HIPAA. You will learn to: MARS Agent, Vault registration, Recovery points.
...
- Extend protection to clinic servers
- Hybrid continuity
...
```mermaid
---
title: Module 10 – Backup for On‑Premises Servers (Flow)
---
flowchart TB
...
```mermaid
---
title: Module 10 – Backup for On‑Premises Servers (Sequence)
---
sequenceDiagram
...
## Pros, Cons & Insights
**Pros**
- Backup for On‑Premises Servers improves resilience for clinical systems and reduces RTO/RPO.
