# Module 8: Backup for SQL Server on Azure VMs

**Intent & Learning Objectives**  
This module introduces **Backup for SQL Server on Azure VMs** and shows how to apply it in a healthcare context where electronic protected health information (ePHI) must be safeguarded under HIPAA. You will learn to: Discover SQL workload, Configure backups, Restore DB.
...
- Protect SQL-backed EHR
- Granular DB restores


**Key Features Demonstrated**
- Discover SQL workload
- Configure backups
- Restore DB
...
```mermaid
---
title: Module 8 – Backup for SQL Server on Azure VMs (Flow)
---
flowchart TB
...
```mermaid
---
title: Module 8 – Backup for SQL Server on Azure VMs (Sequence)
---
sequenceDiagram
...
## Pros, Cons & Insights
**Pros**
- Backup for SQL Server on Azure VMs improves resilience for clinical systems and reduces RTO/RPO.
