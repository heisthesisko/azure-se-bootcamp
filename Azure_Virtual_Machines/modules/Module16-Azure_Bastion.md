# Module 16: Azure Bastion

**Top Problems / Features Addressed**
- RDP/SSH via browser without public IPs
- Session logging per compliance

> [!IMPORTANT]
> Use *synthetic* data only. Follow HIPAA/HITRUST: least-privilege RBAC, encrypt data at rest and in transit.

## Intent & Learning Objectives
This module introduces **Azure Bastion** in the context of healthcare provider/payor workloads. You will:
...
- RDP/SSH via browser without public IPs
- Session logging per compliance
- Bastion SKU selection
- Lockdown management planes

## Architecture Diagram – Azure Bastion
```mermaid
