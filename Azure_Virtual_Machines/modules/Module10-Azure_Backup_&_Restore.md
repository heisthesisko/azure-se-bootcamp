...
- Backup to Recovery Services Vault
- Policy schedules and retention
- Restore full/disk/file
- Cross-region considerations

## Architecture Diagram – Azure Backup & Restore
```mermaid
...
sequenceDiagram
  ...
  participant VM as VM: Azure Backup & Restore
  participant Sec as Defender/Policy
  participant RSV as Recovery Vault
  Eng->>Azure: az scripts (Module 10)
