# Module 02: Managed Disks

**Top Problems / Features Addressed**
- Durable VM storage for EHR DB, PACS cache
- Choice of Premium/Ultra disks for IO-intensive imaging

> [!IMPORTANT]
> Use *synthetic* data only. Follow HIPAA/HITRUST: least-privilege RBAC, encrypt data at rest and in transit.

## Intent & Learning Objectives
This module introduces **Managed Disks** in the context of healthcare provider/payor workloads. You will:
...
- Durable VM storage for EHR DB, PACS cache
- Choice of Premium/Ultra disks for IO-intensive imaging
- Snapshot/resize lifecycle for DR
- Disk caching policies for read-heavy workloads

## Architecture Diagram – Managed Disks
```mermaid
