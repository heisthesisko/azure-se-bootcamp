# Module 11: Azure Disk Encryption

**Top Problems / Features Addressed**
- Encrypt at rest with ADE/LUKS
...
This module introduces **Azure Disk Encryption** in the context of healthcare provider/payor workloads. You will:
...
## Architecture Diagram – Azure Disk Encryption
```mermaid
...
sequenceDiagram
  ...
  participant VM as VM: Azure Disk Encryption
  participant Sec as Defender/Policy
  participant RSV as Recovery Vault
  Eng->>Azure: az scripts (Module 11)
...
3. Apply this module’s configuration:
   ```bash
   bash infra/12_disk_encryption.sh
   ```
