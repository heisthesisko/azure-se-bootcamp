# Module 09: Azure Security Center Integration

**Top Problems / Features Addressed**
- Secure score visibility
- JIT access, endpoint protection integration

> [!IMPORTANT]
> Use *synthetic* data only. Follow HIPAA/HITRUST: least-privilege RBAC, encrypt data at rest and in transit.

## Intent & Learning Objectives
This module introduces **Azure Security Center Integration** in the context of healthcare provider/payor workloads. You will:
...
- Recommendations-as-code export
...
flowchart TB
  subgraph Azure["Azure Subscription"]
    RG["Resource Group"]
    VNET["VNet + Subnets"]
    VM["VM(s): Azure Security Center Integration"]
  end
...
sequenceDiagram
  ...
  participant VM as VM: Azure Security Center Integration
  participant Sec as Defender/Policy
  participant RSV as Recovery Vault
  Eng->>Azure: az scripts (Module 09)
...
3. Apply this module’s configuration:
   ```bash
   bash infra/10_security_center.sh
   ```
