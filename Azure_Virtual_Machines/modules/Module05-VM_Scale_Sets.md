# Module 05: VM Scale Sets

**Top Problems / Features Addressed**
- Autoscale patient portal/API frontends
...
This module introduces **VM Scale Sets** in the context of healthcare provider/payor workloads. You will:
...
- Cost governance for bursts

## Architecture Diagram – VM Scale Sets
```mermaid
