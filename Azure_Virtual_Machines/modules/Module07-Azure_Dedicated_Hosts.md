# Module 07: Azure Dedicated Hosts

**Top Problems / Features Addressed**
- Single-tenant hardware isolation
- Host maintenance control windows

> [!IMPORTANT]
> Use *synthetic* data only. Follow HIPAA/HITRUST: least-privilege RBAC, encrypt data at rest and in transit.

## Intent & Learning Objectives
This module introduces **Azure Dedicated Hosts** in the context of healthcare provider/payor workloads. You will:
...
- Host maintenance control windows
- SKU/region planning
- Audit evidence for isolation requirement

## Architecture Diagram – Azure Dedicated Hosts
```mermaid
...
sequenceDiagram
  ...
  participant VM as VM: Azure Dedicated Hosts
  participant Sec as Defender/Policy
  participant RSV as Recovery Vault
  Eng->>Azure: az scripts (Module 07)
...
3. Apply this module’s configuration:
   ```bash
   bash infra/08_dedicated_host.sh
   ```
