# Module 08: Azure Hybrid Benefit

**Top Problems / Features Addressed**
- Reuse Windows/SQL licenses to cut cost
- Assess eligibility and compliance

> [!IMPORTANT]
> Use *synthetic* data only. Follow HIPAA/HITRUST: least-privilege RBAC, encrypt data at rest and in transit.

## Intent & Learning Objectives
This module introduces **Azure Hybrid Benefit** in the context of healthcare provider/payor workloads. You will:
...
- Reuse Windows/SQL licenses to cut cost
- Assess eligibility and compliance
- Enable/disable at VM creation
- Reporting for audits

## Architecture Diagram – Azure Hybrid Benefit
```mermaid
...
sequenceDiagram
  ...
  participant VM as VM: Azure Hybrid Benefit
  participant Sec as Defender/Policy
  participant RSV as Recovery Vault
  Eng->>Azure: az scripts (Module 08)
...
3. Apply this module’s configuration:
   ```bash
   echo 'Enable Azure Hybrid Benefit using az vm update --license-type where eligible'
   ```
