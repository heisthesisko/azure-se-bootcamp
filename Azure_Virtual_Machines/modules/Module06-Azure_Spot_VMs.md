# Module 06: Azure Spot VMs

**Top Problems / Features Addressed**
- Low-cost compute for research batch jobs (de-identified data)
- Eviction-aware job design

> [!IMPORTANT]
> Use *synthetic* data only. Follow HIPAA/HITRUST: least-privilege RBAC, encrypt data at rest and in transit.

## Intent & Learning Objectives
This module introduces **Azure Spot VMs** in the context of healthcare provider/payor workloads. You will:
...
- Spot + VMSS mix strategies

## Architecture Diagram – Azure Spot VMs
```mermaid
