# VPN Gateway (Site-to-Site with VyOS)

**Intent:** Learn and deploy core features of VPN Gateway (Site-to-Site with VyOS). This module builds on previous modules.
...
**Deploy**
```bash
bash infra/infra/m05_vpn_gateway.sh
```
