...
**Intent & Learning Objectives:** Replicates data across regions for DR.

**Top 2 problems this solves / features provided:**
- Durability across regions
- Option for RA-GRS read access
...
flowchart TB
  ...
  DB --> SA
```
*See also:* `assets/diagrams/module07_flow.mmd`
...
```
*See also:* `assets/diagrams/module07_sequence.mmd`
...
## Files & Scripts
- Module script: `infra/m07_grs.sh`
- Diagrams: `assets/diagrams/module07_flow.mmd`, `assets/diagrams/module07_sequence.mmd`
