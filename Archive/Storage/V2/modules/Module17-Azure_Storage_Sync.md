# Module 17: Azure Storage Sync
**Intent & Learning Objectives:** Synchronize on-prem file servers with Azure Files.
...
- - Agent-based on-prem server sync
...
flowchart TB
  ...
  DB --> SA
```
*See also:* `assets/diagrams/module17_flow.mmd`
...
```
*See also:* `assets/diagrams/module17_sequence.mmd`
...
2. **Run the module script**
   ```bash
   bash infra/m17_storage_sync.sh
   ```
3. **Validate outcome**
...
## Files & Scripts
- Module script: `infra/m17_storage_sync.sh`
- Diagrams: `assets/diagrams/module17_flow.mmd`, `assets/diagrams/module17_sequence.mmd`
