# Module 10: Azure Storage Access Tiers (Hot/Cool/Archive)
**Intent & Learning Objectives:** Optimize cost based on usage patterns.
...
flowchart TB
  ...
  DB --> SA
```
*See also:* `assets/diagrams/module10_flow.mmd`
...
```
*See also:* `assets/diagrams/module10_sequence.mmd`
...
2. **Run the module script**
   ```bash
   bash infra/m10_access_tiers.sh
   ```
3. **Validate outcome**
...
## Files & Scripts
- Module script: `infra/m10_access_tiers.sh`
- Diagrams: `assets/diagrams/module10_flow.mmd`, `assets/diagrams/module10_sequence.mmd`
