    ...
    # Module17: Geo-redundant Storage (GRS)

    **Top Problems/Features Addressed**
    1. Resilience to regional outages.
1. Optional read from secondary.

    **Intent & Learning Objectives**
    - Understand Geo-redundant Storage (GRS) and when to use it.
    - Deploy and validate using Bash + Azure CLI.
    - Demonstrate three or more core features.

    **Key Features Demonstrated**
    - Switch to GRS/RA-GRS.
- Inspect secondary location.
- Discuss failover.
