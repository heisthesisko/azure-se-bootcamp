    ...
    # Module15: Azure Storage Encryption

    **Top Problems/Features Addressed**
    1. Data-at-rest encryption.
1. Scoped encryption scopes.

    **Intent & Learning Objectives**
    - Understand Azure Storage Encryption and when to use it.
...
- Apply to containers (conceptual).
