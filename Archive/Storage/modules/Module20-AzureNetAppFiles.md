    ...
    # Module20: Azure NetApp Files

    **Top Problems/Features Addressed**
    1. High-performance enterprise storage.
1. NFS/SMB volumes.

    **Intent & Learning Objectives**
    - Understand Azure NetApp Files and when to use it.
    - Deploy and validate using Bash + Azure CLI.
    - Demonstrate three or more core features.

    **Key Features Demonstrated**
    - Create account/pool/volume.
- Mount targets (conceptual).
- Quota/region constraints.
