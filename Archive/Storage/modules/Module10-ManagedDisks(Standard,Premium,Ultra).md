    ...
    # Module10: Managed Disks (Standard, Premium, Ultra)

    **Top Problems/Features Addressed**
    1. Choose performance tiers.
1. Understand quotas/region support.

    **Intent & Learning Objectives**
    - Understand Managed Disks (Standard, Premium, Ultra) and when to use it.
