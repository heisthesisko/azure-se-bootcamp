    ...
    # Module04: Immutable Blob Storage

    **Top Problems/Features Addressed**
    1. Meet WORM compliance to prevent edits/deletes.
1. Legal hold for investigations.

    **Intent & Learning Objectives**
    - Understand Immutable Blob Storage and when to use it.
