    ...
    # Module03: Blob Tiers (Hot, Cool, Archive)

    **Top Problems/Features Addressed**
    1. Optimize costs via tiering by access patterns.
1. Handle rehydration from archive.

    **Intent & Learning Objectives**
    - Understand Blob Tiers (Hot, Cool, Archive) and when to use it.
    - Deploy and validate using Bash + Azure CLI.
    - Demonstrate three or more core features.

    **Key Features Demonstrated**
    - Set blob access tiers.
- Understand rehydration timelines/cost.
...
flowchart TB
  ...
  VM --> SA
    ...
    2. Execute scripts for this module:
       - `scripts/03_blob_tiers.sh`
- `scripts/06_lifecycle.sh`
