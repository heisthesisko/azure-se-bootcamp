    ...
    # Module02: Azure Blob Storage

    **Top Problems/Features Addressed**
    1. Store unstructured data like images and logs.
1. Need programmatic access to upload/download/list.

    **Intent & Learning Objectives**
    - Understand Azure Blob Storage and when to use it.
    - Deploy and validate using Bash + Azure CLI.
    - Demonstrate three or more core features.

    **Key Features Demonstrated**
    - Create containers and upload blobs.
- List and download using CLI.
- Use SAS for limited access.
