    ...
    # Module13: Azure Data Lake Storage Gen2

    **Top Problems/Features Addressed**
    1. Hierarchical filesystem for analytics.
1. POSIX ACLs.

    **Intent & Learning Objectives**
    - Understand Azure Data Lake Storage Gen2 and when to use it.
