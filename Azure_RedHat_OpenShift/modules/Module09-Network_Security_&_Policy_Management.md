# Module 9: Network Security & Policy Management

**Intent & Learning Objectives:** Hands-on introduction to **Network Security & Policy Management** for healthcare workloads (HIPAA/HITRUST/FHIR/DICOM). You will start from zero and finish with a working, validated configuration.

> [!IMPORTANT]
> Top two problems this module solves: **Segmentation**, **Enforcement**.

**Key Features Demonstrated:** At least three core capabilities of network security & policy management with step-by-step labs and verification.

## Architecture Diagram
```mermaid
%% assets/diagrams/module09_flow.mmd
flowchart TB
  A["Module 09 Start"] --> B["Core Step"]
  B --> C["Result"]
...
## Sequence Diagram
```mermaid
%% assets/diagrams/module09_sequence.mmd
sequenceDiagram
  participant U as User
  participant S as Service
  U->>S: Module 09 request
  S-->>U: Response
