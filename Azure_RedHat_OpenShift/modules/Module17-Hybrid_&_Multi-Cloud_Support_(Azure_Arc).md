# Module 17: Hybrid & Multi-Cloud Support (Azure Arc)

**Intent & Learning Objectives:** Hands-on introduction to **Hybrid & Multi-Cloud Support (Azure Arc)** for healthcare workloads (HIPAA/HITRUST/FHIR/DICOM). You will start from zero and finish with a working, validated configuration.

> [!IMPORTANT]
> Top two problems this module solves: **Unified governance**, **Fleet management**.

**Key Features Demonstrated:** At least three core capabilities of hybrid & multi-cloud support (azure arc) with step-by-step labs and verification.

## Architecture Diagram
```mermaid
%% assets/diagrams/module17_flow.mmd
flowchart TB
  A["Module 17 Start"] --> B["Core Step"]
  B --> C["Result"]
...
2. **Execute Core Script(s) / Commands**  
   ```bash
   # Scripts: infra/17_connect_azure_arc.sh
